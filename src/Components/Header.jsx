    ...
    <>
      <div className="carousel w-full">
        <div id="slide1" className="carousel-item relative w-full">
          ...
          >
            <div className="hero-overlay bg-gradient-to-r from-base-400 bg-opacity-10"></div>
            <div className="w-10/12 mx-auto font-Roboto">
              <div className="max-w-xl">
                ...
                <h1 className="font-Playfair text-7xl">
                  Make your{" "}
                  <span className="text-blue-600"> dreams a reality</span>
                </h1>
                <p className="py-5 text-2xl font-light">
                ...
                <div className="uppercase flex items-center gap-5">
                  <Link
                    className="btn rounded-full bg-blue-600 text-white border-none"
                    to="/"
                  >
                    Learn More
                  </Link>
                  <Link
                    className="btn rounded-full bg-gray-700 text-white border-none"
                    to="/"
                  >
                    Our Program
                  </Link>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          >
            <div className="hero-overlay bg-gradient-to-r from-base-400 bg-opacity-10"></div>
            <div className="w-8/12 mx-auto font-Roboto flex items-end justify-end">
              <div className="max-w-xl">
                <p className="md:text-2xl uppercase font-semibold py-5">
          ...
          >
            ...
            <div className="w-10/12 mx-auto font-Roboto">
              <div className="max-w-xl">
                ...
                <h1 className="font-Playfair text-7xl text-white">
                  Make your{" "}
                  <span className="text-blue-600"> dreams a reality</span>
                </h1>
                <p className="py-5 text-2xl font-light text-white">
                  Discover your strengths, explore your passions, and find a
                  career path that brings fulfillment and growth for your
                  future.
                </p>
