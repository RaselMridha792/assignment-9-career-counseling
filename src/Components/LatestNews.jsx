        ...
        <div className="w-10/12 mx-auto text-neutral-content text-center py-40 font-Roboto">
          <div className=" text-left w-full">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-5 md:gap-20 md:flex-row">
              <div data-aos="fade-right" className="card bg-opacity-10 hover:shadow-xl duration-300 rounded-none">
                <figure>
                  <img src={news1} alt="" />
                </figure>
              ...
              <div data-aos="fade-left" className="card bg-opacity-10 hover:shadow-xl duration-300 rounded-none">
                <figure>
                  <img src={news3} alt="" />
                </figure>
                <div className="card-body px-5 bg-gray-800 bg-opacity-40 text-white relative">
